...
var getEspnNflScores = function(currentWeek, teamData) {
    $.getJSON( "https://site.api.espn.com/apis/site/v2/sports/football/nfl/scoreboard?year=" + currentWeek[0].Season + "&seasontype=" + currentWeek[0].SeasonType + "&week=" + currentWeek[0].Week, function( scoreData ) {
        var allScores = []
